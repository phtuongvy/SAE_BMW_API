...
namespace SAE_API.Models.DataManager
{
    public class CouleurEquipementManager: IDataRepository<CouleurEquipement>
    {
        ...
        public async Task<ActionResult<CouleurEquipement>> GetByIdAsync(int id, int id2)
        {
            throw new NotImplementedException();
        }
        public async Task<ActionResult<CouleurEquipement>> GetByIdAsync(int id, int? id2, int? id3)
        {
            throw new NotImplementedException();
        }
