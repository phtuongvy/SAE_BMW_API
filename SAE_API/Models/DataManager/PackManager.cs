...
namespace SAE_API.Models.DataManager
{
    public class PackManager : IDataRepository<Pack>
    {
        ...
        public async Task<ActionResult<Pack>> GetByIdAsync(int id, int id2)
        {
            throw new NotImplementedException();
        }
        public async Task<ActionResult<Pack>> GetByIdAsync(int id, int? id2, int? id3)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ActionResult<IEnumerable<Pack>>> GetByIdAsyncList(int id)
        {
            throw new NotImplementedException();
        }
    }
