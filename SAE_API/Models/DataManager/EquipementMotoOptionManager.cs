...
namespace SAE_API.Models.DataManager
{
    public class EquipementMotoOptionManager : IDataRepository<EquipementMotoOption>
    {
        ...
        public async Task<ActionResult<EquipementMotoOption>> GetByIdAsync(int id, int id2)
        {
            throw new NotImplementedException();
        }
        public async Task<ActionResult<EquipementMotoOption>> GetByIdAsync(int id, int? id2, int? id3)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ActionResult<IEnumerable<EquipementMotoOption>>> GetByIdAsyncList(int id)
        {
            throw new NotImplementedException();
        }
    }
