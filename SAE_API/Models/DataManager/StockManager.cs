...
namespace SAE_API.Models.DataManager
{
    public class StockManager : IDataRepository<Stock>
    {
        ...
        public async Task<ActionResult<Stock>> GetByIdAsync(int id, int id2)
        {
            throw new NotImplementedException();
        }
        public async Task<ActionResult<Stock>> GetByIdAsync(int id, int? id2, int? id3)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ActionResult<IEnumerable<Stock>>> GetByIdAsyncList(int id)
        {
            throw new NotImplementedException();
        }
    }
