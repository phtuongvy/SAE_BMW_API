...
namespace SAE_API.Models.DataManager
{
    public class TransationManager : IDataRepository<Transation>
    {
        ...
        public async Task<ActionResult<Transation>> GetByIdAsync(int id , int id2)
        {
            throw new NotImplementedException();
        }
        public async Task<ActionResult<Transation>> GetByIdAsync(int id, int? id2, int? id3)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ActionResult<IEnumerable<Transation>>> GetByIdAsyncList(int id)
        {
            throw new NotImplementedException();
        }
    }
