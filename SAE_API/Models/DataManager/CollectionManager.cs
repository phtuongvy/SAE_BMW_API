...
namespace SAE_API.Models.DataManager
{
    public class CollectionManager : IDataRepository<Collection>
    {
        ...
        public async Task<ActionResult<Collection>> GetByIdAsync(int id, int id2)
        {
           throw new NotImplementedException();
        }
        public async Task<ActionResult<Collection>> GetByIdAsync(int id, int? id2, int? id3)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ActionResult<IEnumerable<Collection>>> GetByIdAsyncList(int id)
        {
            throw new NotImplementedException();
        }
    }
